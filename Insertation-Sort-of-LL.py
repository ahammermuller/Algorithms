...
class LinkedList:
    ...
    def insertion_sort(self):
        ...
        # Initialize the sorted list with the first element and the unsorted list with the second element.
        ...
        while unsorted_list_head is not None:
            ...
            # add it at the beginning of the sorted list.
            if current.value < sorted_list_head.value:
                current.next = sorted_list_head
                sorted_list_head = current
            else:
                # Find the appropriate position in the sorted list for the current element.
        ...
        # Update the head and tail pointers after sorting.
